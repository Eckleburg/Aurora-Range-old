...
void rainbowSkip(int skip, int dir) 
{
  ...
  for(int rSkipCounter=255; rSkipCounter>0; rSkipCounter--)
  {
    ...
    {     
      ...
      assignColor(1, Wheel((dir*rSkipCounter+int(offset))&255));
      assignColor(2, Wheel((dir*rSkipCounter+int(2*offset))&255));
      assignColor(3, Wheel((dir*rSkipCounter+int(3*offset))&255));
      assignColor(4, Wheel((dir*rSkipCounter+int(4*offset))&255));
      assignColor(5, Wheel((dir*rSkipCounter+int(5*offset))&255));
      assignColor(6, Wheel((dir*rSkipCounter+int(6*offset))&255));
      assignColor(7, Wheel((dir*rSkipCounter+int(7*offset))&255));
      assignColor(8, Wheel((dir*rSkipCounter+int(8*offset))&255));
      assignColor(9, Wheel((dir*rSkipCounter+int(9*offset))&255));
      assignColor(10, Wheel((dir*rSkipCounter+int(10*offset))&255));
      assignColor(11, Wheel((dir*rSkipCounter+int(11*offset))&255));
