...
void loop() {
  ...
  {int start, fin, dif;
      ...
      {
        layer0.setPixelColor(i, Wheel(((-i * (steps+1) / dif) + j - 10)));
      }
      ...
      for(int i=start ; i<fin; i++)
      {
        layer1.setPixelColor(i, Wheel(((-i * (steps+1) / dif) + j - 10) & steps));
      }
      ...
      for(int i=start ; i<fin; i++)
      {
        layer2.setPixelColor(i, Wheel(((-i * (steps+1) / dif) + j - 10) & steps));
      }
      ...
      for(int i=start ; i<fin; i++)
      {
        layer3.setPixelColor(i, Wheel(((-i * (steps+1) / dif) + j - 10) & steps));
      }
      ...
      for(int i=start ; i<fin; i++)
      {
        layer4.setPixelColor(i, Wheel(((-i * (steps+1) / dif) + j - 10) & steps));
      }
      ...
      for(int i=start ; i<fin; i++)
      {
        layer5.setPixelColor(i, Wheel(((-i * (steps+1) / dif) + j - 10) & steps));
      }
      ...
      for(int i=start ; i<fin; i++)
      {
        layer6.setPixelColor(i, Wheel(((-i * (steps+1) / dif) + j - 10) & steps));
      }
      ...
      for(int i=start ; i<fin; i++)
      {
        layer7.setPixelColor(i, Wheel(((-i * (steps+1) / dif) + j - 10) & steps));
      }
      ...
      for(int i=start ; i<fin; i++)
      {
        layer8.setPixelColor(i, Wheel(((-i * (steps+1) / dif) + j - 10) & steps));
      }
      ...
      for(int i=start ; i<fin; i++)
      {
        layer9.setPixelColor(i, Wheel(((-i * (steps+1) / dif) + j - 10) & steps));
      }
      ...
      for(int i=start ; i<fin; i++)
      {
        layer10.setPixelColor(i, Wheel(((-i * (steps+1) / dif) + j - 10) & steps));
      }
      ...
      for(int i=start ; i<fin; i++)
      {
        layer11.setPixelColor(i, Wheel(((-i * (steps+1) / dif) + j - 10) & steps));
      }
...
//  WheelPos = steps - WheelPos;
  if(WheelPos < 85) {
    return layer1.Color(steps - WheelPos * 3, 0, WheelPos * 3);
  }
  if(WheelPos < 2*steps/3) {
    WheelPos -= 85;
    return layer1.Color(0, WheelPos * 3, steps - WheelPos * 3);
  }
  WheelPos -= 2*steps/3;
  return layer1.Color(WheelPos * 3, steps - WheelPos * 3, 0);
}
