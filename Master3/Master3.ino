...
uint32_t prevAnim[300], curAnim[300], nextAnim[300];
...
void displayAnimUp(int offset)
{
  for(int animCntr = 0; animCntr < 300; animCntr++)
  {
    for(int layerCntr = 0; layerCntr <= 11; layerCntr++)
    {
      if(animCntr < layerCntr*offset)
      assignLayer(layerCntr, prevAnim[animCntr-layerCntr*offset+300]);
      else
